...
I constantly adjust this list, so it will most likely change by the time you read this. The more relays you are connected to, the more work your phone's modem has to do 
maintaining those connections. Many events you will receive from each relay are also duplicates, as many of your friends will have similar relays listed as you do! This costs energy as your phone's processor has to process these feeds from every relay you use, and toss out duplicates.

Remember, you only need _one_ shared relay with any given friend to be able to communicate.

**Web UI's**

Web UI's are complicated. On a powerful desktop computer, you can get away with quite a number of connected relays. I have had as many as 25 or so while running snort 
on a Ryzen 5800X, and had no issues.
